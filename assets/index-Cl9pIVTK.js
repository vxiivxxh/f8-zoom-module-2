(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function r(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(n){if(n.ep)return;n.ep=!0;const a=r(n);fetch(n.href,a)}})();var _e=/([:*])(\w+)/g,Le="([^/]+)",Pe=/\*/g,Ae="?(?:.*)",Te=/\/\?/g,Ce="/?([^/]+|)",Ie="(?:/^|^)",Oe="";function te(e){return e===void 0&&(e="/"),V()?location.pathname+location.search+location.hash:e}function v(e){return e.replace(/\/+$/,"").replace(/^\/+/,"")}function O(e){return typeof e=="string"}function Re(e){return typeof e=="function"}function R(e){return e&&e.indexOf("#")>=0&&e.split("#").pop()||""}function Be(e,t){return t.length===0||!e?null:e.slice(1,e.length).reduce(function(r,s,n){return r===null&&(r={}),r[t[n]]=decodeURIComponent(s),r},null)}function B(e){var t=v(e).split(/\?(.*)?$/);return[v(t[0]),t.slice(1).join("")]}function F(e){for(var t={},r=e.split("&"),s=0;s<r.length;s++){var n=r[s].split("=");if(n[0]!==""){var a=decodeURIComponent(n[0]);t[a]?(Array.isArray(t[a])||(t[a]=[t[a]]),t[a].push(decodeURIComponent(n[1]||""))):t[a]=decodeURIComponent(n[1]||"")}}return t}function re(e,t){var r=B(v(e.currentLocationPath)),s=r[0],n=r[1],a=n===""?null:F(n),o=[],c;if(O(t.path)){if(c=Ie+v(t.path).replace(_e,function(m,y,b){return o.push(b),Le}).replace(Pe,Ae).replace(Te,Ce)+"$",v(t.path)===""&&v(s)==="")return{url:s,queryString:n,hashString:R(e.to),route:t,data:null,params:a}}else c=t.path;var d=new RegExp(c,Oe),p=s.match(d);if(p){var f=O(t.path)?Be(p,o):p.groups?p.groups:p.slice(1);return{url:v(s.replace(new RegExp("^"+e.instance.root),"")),queryString:n,hashString:R(e.to),route:t,data:f,params:a}}return!1}function se(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function P(e,t){return typeof e[t]>"u"||e[t]===!0}function He(e){if(!e)return{};var t=e.split(","),r={},s;return t.forEach(function(n){var a=n.split(":").map(function(o){return o.replace(/(^ +| +$)/g,"")});switch(a[0]){case"historyAPIMethod":r.historyAPIMethod=a[1];break;case"resolveOptionsStrategy":s||(s={}),s.strategy=a[1];break;case"resolveOptionsHash":s||(s={}),s.hash=a[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":r[a[0]]=a[1]==="true";break}}),s&&(r.resolveOptions=s),r}function V(){return typeof window<"u"}function je(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter(function(r){return r}).forEach(function(r){["before","after","already","leave"].forEach(function(s){r[s]&&(t[s]||(t[s]=[]),t[s].push(r[s]))})}),t}function w(e,t,r){var s=t||{},n=0;(function a(){if(!e[n]){r&&r(s);return}Array.isArray(e[n])?(e.splice.apply(e,[n,1].concat(e[n][0](s)?e[n][1]:e[n][2])),a()):e[n](s,function(o){typeof o>"u"||o===!0?(n+=1,a()):r&&r(s)})})()}w.if=function(e,t,r){return Array.isArray(t)||(t=[t]),Array.isArray(r)||(r=[r]),[e,t,r]};function W(e,t){typeof e.currentLocationPath>"u"&&(e.currentLocationPath=e.to=te(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function H(e,t){for(var r=0;r<e.instance.routes.length;r++){var s=e.instance.routes[r],n=re(e,s);if(n&&(e.matches||(e.matches=[]),e.matches.push(n),e.resolveOptions.strategy==="ONE")){t();return}}t()}function qe(e,t){e.navigateOptions&&(typeof e.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof e.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),t()}function $e(e,t){e.navigateOptions.force===!0?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}var K=V(),Me=se();function Ne(e,t){if(P(e.navigateOptions,"updateBrowserURL")){var r=("/"+e.to).replace(/\/\//g,"/"),s=K&&e.resolveOptions&&e.resolveOptions.hash===!0;Me?(history[e.navigateOptions.historyAPIMethod||"pushState"](e.navigateOptions.stateObj||{},e.navigateOptions.title||"",s?"#"+r:r),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout(function(){if(!s){var n=location.hash;location.hash="",location.hash=n}e.instance.__freezeListening=!1},1))):K&&(window.location.href=e.to)}t()}function ne(e,t){var r=e.instance;if(!r.lastResolved()){t();return}w(r.lastResolved().map(function(s){return function(n,a){if(!s.route.hooks||!s.route.hooks.leave){a();return}var o=!1,c=e.instance.matchLocation(s.route.path,e.currentLocationPath,!1);if(s.route.path!=="*")o=!c;else{var d=e.matches?e.matches.find(function(p){return s.route.path===p.route.path}):!1;o=!d}if(P(e.navigateOptions,"callHooks")&&o){w(s.route.hooks.leave.map(function(p){return function(f,m){return p(function(y){y===!1?e.instance.__markAsClean(e):m()},e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}}).concat([function(){return a()}]));return}else a()}}),{},function(){return t()})}function ze(e,t){e.match.route.hooks&&e.match.route.hooks.before&&P(e.navigateOptions,"callHooks")?w(e.match.route.hooks.before.map(function(r){return function(n,a){return r(function(o){o===!1?e.instance.__markAsClean(e):a()},e.match)}}).concat([function(){return t()}])):t()}function Fe(e,t){P(e.navigateOptions,"callHandler")&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()}function Ve(e,t){e.match.route.hooks&&e.match.route.hooks.after&&P(e.navigateOptions,"callHooks")&&e.match.route.hooks.after.forEach(function(r){return r(e.match)}),t()}function Ue(e,t){var r=e.instance.lastResolved();if(r&&r[0]&&r[0].route===e.match.route&&r[0].url===e.match.url&&r[0].queryString===e.match.queryString){r.forEach(function(s){s.route.hooks&&s.route.hooks.already&&P(e.navigateOptions,"callHooks")&&s.route.hooks.already.forEach(function(n){return n(e.match)})}),t(!1);return}t()}function De(e,t){var r=e.instance._notFoundRoute;if(r){e.notFoundHandled=!0;var s=B(e.currentLocationPath),n=s[0],a=s[1],o=R(e.to);r.path=v(n);var c={url:r.path,queryString:a,hashString:o,data:null,route:r,params:a!==""?F(a):null};e.matches=[c],e.match=c}t()}function Ge(e,t){(!e.resolveOptions||e.resolveOptions.noMatchWarning===!1||typeof e.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+e.currentLocationPath+`" didn't match any of the registered routes.`),t()}function Ye(e,t){e.instance._setCurrent(null),t()}function ie(e,t){P(e.navigateOptions,"updateState")&&e.instance._setCurrent(e.matches),t()}var ae=[Ue,ze,Fe,Ve],J=[ne,De,w.if(function(e){var t=e.notFoundHandled;return t},ae.concat([ie]),[Ge,Ye])];function N(){return N=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var s in r)Object.prototype.hasOwnProperty.call(r,s)&&(e[s]=r[s])}return e},N.apply(this,arguments)}function Q(e,t){var r=0;function s(){if(r===e.matches.length){ie(e,t);return}w(ae,N({},e,{match:e.matches[r]}),function(){r+=1,s()})}ne(e,s)}function j(e){e.instance.__markAsClean(e)}function z(){return z=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var s in r)Object.prototype.hasOwnProperty.call(r,s)&&(e[s]=r[s])}return e},z.apply(this,arguments)}var Z="[data-navigo]";function Xe(e,t){var r=t||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:Z},s=this,n="/",a=null,o=[],c=!1,d,p=se(),f=V();e?n=v(e):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function m(i){return i.indexOf("#")>=0&&(r.hash===!0?i=i.split("#")[1]||"/":i=i.split("#")[0]),i}function y(i){return v(n+"/"+v(i))}function b(i,l,u,g){return i=O(i)?y(i):i,{name:g||v(String(i)),path:i,handler:l,hooks:je(u)}}function _(i,l,u){var g=this;return typeof i=="object"&&!(i instanceof RegExp)?(Object.keys(i).forEach(function(h){if(typeof i[h]=="function")g.on(h,i[h]);else{var x=i[h],T=x.uses,Se=x.as,Ee=x.hooks;o.push(b(h,T,[d,Ee],Se))}}),this):(typeof i=="function"&&(u=l,l=i,i=n),o.push(b(i,l,[d,u])),this)}function C(i,l){if(s.__dirty){s.__waiting.push(function(){return s.resolve(i,l)});return}else s.__dirty=!0;i=i?v(n)+"/"+v(i):void 0;var u={instance:s,to:i,currentLocationPath:i,navigateOptions:{},resolveOptions:z({},r,l)};return w([W,H,w.if(function(g){var h=g.matches;return h&&h.length>0},Q,J)],u,j),u.matches?u.matches:!1}function U(i,l){if(s.__dirty){s.__waiting.push(function(){return s.navigate(i,l)});return}else s.__dirty=!0;i=v(n)+"/"+v(i);var u={instance:s,to:i,navigateOptions:l||{},resolveOptions:l&&l.resolveOptions?l.resolveOptions:r,currentLocationPath:m(i)};w([qe,$e,H,w.if(function(g){var h=g.matches;return h&&h.length>0},Q,J),Ne,j],u,j)}function ce(i,l,u){var g=G(i,l);return g!==null?(U(g.replace(new RegExp("^/?"+n),""),u),!0):!1}function ue(i){return this.routes=o=o.filter(function(l){return O(i)?v(l.path)!==v(i):Re(i)?i!==l.handler:String(l.path)!==String(i)}),this}function de(){p&&(this.__popstateListener=function(){s.__freezeListening||C()},window.addEventListener("popstate",this.__popstateListener))}function he(){this.routes=o=[],p&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=c=!0}function fe(i,l){return s._notFoundRoute=b("*",i,[d,l],"__NOT_FOUND__"),this}function D(){if(f)return pe().forEach(function(i){if(i.getAttribute("data-navigo")==="false"||i.getAttribute("target")==="_blank"){i.hasListenerAttached&&i.removeEventListener("click",i.navigoHandler);return}i.hasListenerAttached||(i.hasListenerAttached=!0,i.navigoHandler=function(l){if((l.ctrlKey||l.metaKey)&&l.target.tagName.toLowerCase()==="a")return!1;var u=i.getAttribute("href");if(typeof u>"u"||u===null)return!1;if(u.match(/^(http|https)/)&&typeof URL<"u")try{var g=new URL(u);u=g.pathname+g.search}catch{}var h=He(i.getAttribute("data-navigo-options"));c||(l.preventDefault(),l.stopPropagation(),s.navigate(v(u),h))},i.addEventListener("click",i.navigoHandler))}),s}function pe(){return f?[].slice.call(document.querySelectorAll(r.linksSelector||Z)):[]}function ge(i){return"/"+n+"/"+v(i)}function me(i){return d=i,this}function ve(){return a}function G(i,l,u){var g=o.find(function(T){return T.name===i}),h=null;if(g){if(h=g.path,l)for(var x in l)h=h.replace(":"+x,l[x]);h=h.match(/^\//)?h:"/"+h}return h&&u&&!u.includeRoot&&(h=h.replace(new RegExp("^/"+n),"")),h}function ye(i){return i.getAttribute("href")}function Y(i){var l=B(v(i)),u=l[0],g=l[1],h=g===""?null:F(g),x=R(i),T=b(u,function(){},[d],u);return{url:u,queryString:g,hashString:x,route:T,data:null,params:h}}function be(){return Y(v(te(n)).replace(new RegExp("^"+n),""))}function xe(i){var l={instance:s,currentLocationPath:i,to:i,resolveOptions:r};return H(l,function(){}),l.matches?l.matches:!1}function we(i,l,u){typeof l<"u"&&(typeof u>"u"||u)&&(l=y(l));var g={instance:s,to:l,currentLocationPath:l};W(g,function(){}),typeof i=="string"&&(i=typeof u>"u"||u?y(i):i);var h=re(g,{name:String(i),path:i,handler:function(){},hooks:{}});return h||!1}function I(i,l,u){return typeof l=="string"&&(l=X(l)),l?(l.hooks[i]||(l.hooks[i]=[]),l.hooks[i].push(u),function(){l.hooks[i]=l.hooks[i].filter(function(g){return g!==u})}):(console.warn("Route doesn't exists: "+l),function(){})}function X(i){return typeof i=="string"?o.find(function(l){return l.name===y(i)}):o.find(function(l){return l.handler===i})}function ke(i){i.instance.__dirty=!1,i.instance.__waiting.length>0&&i.instance.__waiting.shift()()}this.root=n,this.routes=o,this.destroyed=c,this.current=a,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=ke,this.on=_,this.off=ue,this.resolve=C,this.navigate=U,this.navigateByName=ce,this.destroy=he,this.notFound=fe,this.updatePageLinks=D,this.link=ge,this.hooks=me,this.extractGETParameters=function(i){return B(m(i))},this.lastResolved=ve,this.generate=G,this.getLinkPath=ye,this.match=xe,this.matchLocation=we,this.getCurrentLocation=be,this.addBeforeHook=I.bind(this,"before"),this.addAfterHook=I.bind(this,"after"),this.addAlreadyHook=I.bind(this,"already"),this.addLeaveHook=I.bind(this,"leave"),this.getRoute=X,this._pathToMatchObject=Y,this._clean=v,this._checkForAHash=m,this._setCurrent=function(i){return a=s.current=i},de.call(this),D.call(this)}const We="https://youtube-music.f8team.dev/api",L={async request(e,t={}){const r=`${We}${e}`,s={"Content-Type":"application/json",...t.headers},n=localStorage.getItem("accessToken");n&&(s.Authorization=`Bearer ${n}`);const a={...t,headers:s};try{const o=await fetch(r,a),c=await o.json();if(!o.ok)throw new Error(c.message||"API Error");return c}catch(o){throw console.error("API Request Failed:",o),o}},get(e,t={}){return this.request(e,{...t,method:"GET"})},post(e,t,r={}){return this.request(e,{...r,method:"POST",body:JSON.stringify(t)})},put(e,t,r={}){return this.request(e,{...r,method:"PUT",body:JSON.stringify(t)})},delete(e,t={}){return this.request(e,{...t,method:"DELETE"})}};class Ke{constructor(){this.state={user:null,isAuthenticated:!1,isLoading:!0},this.listeners=[],this.init()}subscribe(t){return this.listeners.push(t),()=>{this.listeners=this.listeners.filter(r=>r!==t)}}notify(){this.listeners.forEach(t=>t(this.state))}async init(){if(localStorage.getItem("accessToken"))try{await this.fetchCurrentUser()}catch(r){console.error("Session expired or invalid:",r),this.logout()}else this.setState({isLoading:!1})}setState(t){this.state={...this.state,...t},this.notify()}async login(t,r){this.setState({isLoading:!0});try{const s=await L.post("/auth/login",{email:t,password:r}),{accessToken:n,refreshToken:a}=s.data||s;return localStorage.setItem("accessToken",n),localStorage.setItem("refreshToken",a),await this.fetchCurrentUser(),{success:!0}}catch(s){return this.setState({isLoading:!1}),{success:!1,error:s.message}}}async register(t,r,s,n){this.setState({isLoading:!0});try{return await L.post("/auth/register",{name:t,email:r,password:s,confirmPassword:n}),this.setState({isLoading:!1}),{success:!0}}catch(a){return this.setState({isLoading:!1}),{success:!1,error:a.message}}}async logout(){localStorage.removeItem("accessToken"),localStorage.removeItem("refreshToken"),this.setState({user:null,isAuthenticated:!1,isLoading:!1})}async fetchCurrentUser(){try{const t=await L.get("/auth/me");this.setState({user:t.data,isAuthenticated:!0,isLoading:!1})}catch(t){throw t}}get isAuthenticated(){return this.state.isAuthenticated}get user(){return this.state.user}}const S=new Ke,Je=e=>{const t=document.getElementById("app"),r=`
  ...
  `;t.innerHTML=r;const s=document.getElementById("login-form"),n=document.getElementById("error-message");s.addEventListener("submit",async a=>{a.preventDefault();const o=document.getElementById("email").value,c=document.getElementById("password").value;n.classList.add("hidden"),n.textContent="";const d=s.querySelector('button[type="submit"]'),p=d.textContent;d.disabled=!0,d.textContent="Đang đăng nhập...";const f=await S.login(o,c);f.success?e.navigate("/"):(n.textContent=f.error||"Đăng nhập thất bại. Vui lòng kiểm tra lại thông tin.",n.classList.remove("hidden"),d.disabled=!1,d.textContent=p)})},Qe=e=>{const t=document.getElementById("app"),r=`
    <div class="flex items-center justify-center min-h-screen bg-yt-black font-sans">
      <div class="w-full max-w-md p-8 rounded-lg bg-yt-player shadow-2xl">
        <div class="flex justify-center mb-8">
          <img src="https://music.youtube.com/img/on_platform_logo_dark.svg" alt="YouTube Music" class="h-8">
  ...
  `;t.innerHTML=r;const s=document.getElementById("register-form"),n=document.getElementById("error-message");s.addEventListener("submit",async a=>{a.preventDefault();const o=document.getElementById("name").value,c=document.getElementById("email").value,d=document.getElementById("password").value,p=document.getElementById("confirm-password").value;if(d!==p){n.textContent="Mật khẩu không khớp",n.classList.remove("hidden");return}n.classList.add("hidden"),n.textContent="";const f=s.querySelector('button[type="submit"]'),m=f.textContent;f.disabled=!0,f.textContent="Đang đăng ký...";const y=await S.register(o,c,d,p);y.success?e.navigate("/login"):(n.textContent=y.error||"Đăng ký thất bại.",n.classList.remove("hidden"),f.disabled=!1,f.textContent=m)})},Ze="modulepreload",et=function(e){return"/f8-zoom-module-2/"+e},ee={},oe=function(t,r,s){let n=Promise.resolve();if(r&&r.length>0){let p=function(f){return Promise.all(f.map(m=>Promise.resolve(m).then(y=>({status:"fulfilled",value:y}),y=>({status:"rejected",reason:y}))))};var o=p;document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),d=c?.nonce||c?.getAttribute("nonce");n=p(r.map(f=>{if(f=et(f),f in ee)return;ee[f]=!0;const m=f.endsWith(".css"),y=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${f}"]${y}`))return;const b=document.createElement("link");if(b.rel=m?"stylesheet":Ze,m||(b.as="script"),b.crossOrigin="",b.href=f,d&&b.setAttribute("nonce",d),document.head.appendChild(b),m)return new Promise((_,C)=>{b.addEventListener("load",_),b.addEventListener("error",()=>C(new Error(`Unable to preload CSS for ${f}`)))})}))}function a(c){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=c,window.dispatchEvent(d),!d.defaultPrevented)throw c}return n.then(c=>{for(const d of c||[])d.status==="rejected"&&a(d.reason);return t().catch(a)})},tt=()=>`
    <aside class="fixed top-0 left-0 w-sidebar h-full bg-yt-sidebar text-yt-text-secondary flex flex-col pt-4 z-sidebar border-r border-gray-800">
      <div class="px-6 mb-6 flex items-center gap-1 cursor-pointer" onclick="window.history.pushState({}, '', '/'); window.dispatchEvent(new PopStateEvent('popstate'));">
      ...
      <nav class="flex-1 px-4 space-y-2">
        <a href="/" class="flex items-center gap-4 px-4 py-3 rounded-lg hover:bg-yt-hover hover:text-yt-text-primary transition-colors data-navigo" data-navigo>
          <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg>
          <span class="font-medium text-sm">Trang chủ</span>
        </a>
        <a href="/explore" class="flex items-center gap-4 px-4 py-3 rounded-lg hover:bg-yt-hover hover:text-yt-text-primary transition-colors data-navigo" data-navigo>
        ...
        <a href="/library" class="flex items-center gap-4 px-4 py-3 rounded-lg hover:bg-yt-hover hover:text-yt-text-primary transition-colors data-navigo" data-navigo>
  ...
  `},$=()=>{const e=document.getElementById("player-play"),t=document.getElementById("player-next"),r=document.getElementById("player-prev"),s=document.getElementById("player-toggle-video");e&&(e.onclick=()=>E.togglePlay()),t&&(t.onclick=()=>E.next()),r&&(r.onclick=()=>E.prev()),s&&(s.onclick=()=>{const n=document.getElementById("yt-player-container");n&&(n.classList.toggle("hidden-video"),s.classList.toggle("text-white"),s.classList.toggle("text-yt-text-secondary"))})},A=(e,t)=>{const r=document.getElementById("app");(()=>{r.innerHTML=`
        <div class="flex h-screen w-screen bg-yt-base text-yt-text-primary overflow-hidden">
            ...
            ${E.state.currentSong?q():""}
        </div>
    `,st(t),E.state.currentSong&&$();const n=window.location.pathname;document.querySelectorAll("nav a").forEach(o=>{o.getAttribute("href")===n&&o.classList.add("bg-yt-hover","text-yt-text-primary")})})(),E.subscribe(n=>{const a=document.querySelector(".bg-yt-player.fixed.bottom-0");if(n.currentSong&&!a){const o=document.querySelector("#app > div");if(o){const c=document.createElement("div");c.innerHTML=q(),o.appendChild(c.firstElementChild),$()}}else if(n.currentSong&&a){const o=document.createElement("div");o.innerHTML=q(),a.replaceWith(o.firstElementChild),$()}})},it=async e=>{A(`
      <div class="flex items-center justify-center h-64">
          <div class="w-8 h-8 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
      </div>
  `,e);try{const[t,r,s]=await Promise.all([L.get("/home/albums-for-you"),L.get("/home/todays-hits"),L.get("/quick-picks")]),n=Array.isArray(t)?t:t.data||[],a=Array.isArray(r)?r:r.data||[],o=Array.isArray(s)?s:s.data||[],c=S.user,p=`
      <div class="space-y-10">
        ...
        <section>
          ...
          <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-6">
             ${a.slice(0,6).map(m=>M(m)).join("")}
          </div>
        </section>
      </div>
    `;A(p,e);const f=document.querySelector("main");f&&f.addEventListener("click",m=>{const y=m.target.closest(".song-card");if(y)try{const b=JSON.parse(y.dataset.song);oe(async()=>{const{playerStore:_}=await Promise.resolve().then(()=>le);return{playerStore:_}},void 0).then(({playerStore:_})=>{_.play(b)})}catch(b){console.error("Failed to play song",b)}})}catch(t){console.error("Home load error",t),A(`
    ...
    `,e)}},M=e=>{const t=e.title||e.name||"Không có tiêu đề",r=Array.isArray(e.artists)?e.artists.map(n=>typeof n=="string"?n:n.name).join(", "):e.description||"",s=e.thumbnails&&e.thumbnails[0]||e.thumbnail||e.image||"https://via.placeholder.com/300";return`
  ...
  `,e);try{const[t]=await Promise.all([L.get("/explore/new-releases")]),r=t.items||t.data||[],n=`
       <div class="space-y-8">
         ...
         <div class="flex gap-3 overflow-x-auto pb-2 scrollbar-none">
            ${["Mới phát hành","Bảng xếp hạng","Tâm trạng","Pop","Rock","Hiphop v.v."].map((o,c)=>`
         ...
         <section>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
               ${r.slice(0,10).map(o=>ot(o)).join("")}
            </div>
         </section>
       </div>
     `;A(n,e);const a=document.querySelector("main");a&&a.addEventListener("click",o=>{const c=o.target.closest(".song-card");if(c)try{const d=JSON.parse(c.dataset.song);oe(async()=>{const{playerStore:p}=await Promise.resolve().then(()=>le);return{playerStore:p}},void 0).then(({playerStore:p})=>{p.play(d)})}catch(d){console.error("Failed to play song",d)}})}catch(t){console.error("Explore load error",t),A(`
       <div class="text-center py-20 text-red-500">
           <h3 class="text-xl font-bold">Lỗi tải dữ liệu</h3>
           <p>${t.message}</p>
       </div>
    `,e)}},ot=e=>{const t=e.title||e.name||"No Title",r=Array.isArray(e.artists)?e.artists.map(n=>typeof n=="string"?n:n.name).join(", "):"",s=e.thumbnails&&e.thumbnails[0]||e.thumbnail||e.image||"https://via.placeholder.com/300";return`
      <div class="group cursor-pointer song-card" data-song='${JSON.stringify(e).replace(/'/g,"&#39;")}'>
         <div class="relative aspect-square mb-3 rounded overflow-hidden bg-gray-800">
            <img src="${s}" alt="${t}" class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105" loading="lazy">
            <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
