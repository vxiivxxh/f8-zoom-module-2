  ...
  return `
    <aside class="fixed top-0 left-0 w-sidebar bottom-0 bg-yt-sidebar text-yt-text-secondary flex flex-col pt-2 z-50 border-r border-gray-800 transition-all duration-300">
      ...
      <nav class="flex-1 px-3 space-y-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600">
        ...
        <!-- Primary Navigation -->
        <a href="${import.meta.env.BASE_URL}" class="flex items-center gap-5 px-4 py-3 rounded-lg hover:bg-yt-hover hover:text-white transition-colors data-navigo" data-navigo>
          <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg>
          <span class="font-medium text-sm">Trang chủ</span>
        </a>
        <a href="${import.meta.env.BASE_URL}explore" class="flex items-center gap-5 px-4 py-3 rounded-lg hover:bg-yt-hover hover:text-white transition-colors data-navigo" data-navigo>
        ...
        <a href="${import.meta.env.BASE_URL}library" class="flex items-center gap-5 px-4 py-3 rounded-lg hover:bg-yt-hover hover:text-white transition-colors data-navigo" data-navigo>
